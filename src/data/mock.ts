...
export const TEAMS: Team[] = [
  ...
  { id: 'for', name: 'Fortaleza', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Fortaleza_Esporte_Clube_logo.svg/200px-Fortaleza_Esporte_Clube_logo.svg.png', colors: ['#1C3C75', '#FFFFFF', '#CE1126'], founded: 1918, stadium: 'Castelão' },
  { id: 'int', name: 'Internacional', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Escudo_do_Sport_Club_Internacional.svg/200px-Escudo_do_Sport_Club_Internacional.svg.png', colors: ['#FF0000', '#FFFFFF'], founded: 1909, stadium: 'Beira-Rio' },
  { id: 'spfc', name: 'São Paulo', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Sao_Paulo_Futebol_Clube.svg/200px-Sao_Paulo_Futebol_Clube.svg.png', colors: ['#FE0000', '#FFFFFF', '#000000'], founded: 1930, stadium: 'Morumbi' },
  ...
  { id: 'bah', name: 'Bahia', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Esporte_Clube_Bahia_logo.svg/200px-Esporte_Clube_Bahia_logo.svg.png', colors: ['#009CA6', '#FFFFFF', '#CE1126'], founded: 1931, stadium: 'Arena Fonte Nova' },
  { id: 'cru', name: 'Cruzeiro', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Cruzeiro_Esporte_Clube_%28logo%29.svg/200px-Cruzeiro_Esporte_Clube_%28logo%29.svg.png', colors: ['#005CA9', '#FFFFFF'], founded: 1921, stadium: 'Mineirão' },
  { id: 'vas', name: 'Vasco', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Escudo_do_Club_de_Regatas_Vasco_da_Gama.svg/200px-Escudo_do_Club_de_Regatas_Vasco_da_Gama.svg.png', colors: ['#000000', '#FFFFFF'], founded: 1898, stadium: 'São Januário' },
  { id: 'vit', name: 'Vitória', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Escudo_Esporte_Clube_Vit%C3%B3ria_-_2024.png/200px-Escudo_Esporte_Clube_Vit%C3%B3ria_-_2024.png', colors: ['#FF0000', '#000000'], founded: 1899, stadium: 'Barradão' },
  ...
  { id: 'gre', name: 'Grêmio', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Gremio_FBPA_logo.svg/200px-Gremio_FBPA_logo.svg.png', colors: ['#0D80BF', '#000000', '#FFFFFF'], founded: 1903, stadium: 'Arena do Grêmio' },
  { id: 'red', name: 'Bragantino', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Red_Bull_Bragantino.svg/200px-Red_Bull_Bragantino.svg.png', colors: ['#FFFFFF', '#CE1126'], founded: 1928, stadium: 'Nabi Abi Chedid' },
  { id: 'juv', name: 'Juventude', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Juventude_Crest.svg/200px-Juventude_Crest.svg.png', colors: ['#00913F', '#FFFFFF'], founded: 1913, stadium: 'Alfredo Jaconi' },
  // 2025 Promoted
  { id: 'san', name: 'Santos', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Santos_Logo.png/200px-Santos_Logo.png', colors: ['#FFFFFF', '#000000'], founded: 1912, stadium: 'Vila Belmiro' },
  { id: 'mir', name: 'Mirassol', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Mirassol_Futebol_Clube_logo.svg/200px-Mirassol_Futebol_Clube_logo.svg.png', colors: ['#FFC125', '#009000'], founded: 1925, stadium: 'Maião' },
  { id: 'spt', name: 'Sport', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Sport_Club_do_Recife.svg/200px-Sport_Club_do_Recife.svg.png', colors: ['#000000', '#CC0000'], founded: 1905, stadium: 'Ilha do Retiro' },
  { id: 'cea', name: 'Ceará', leagueId: 'bra-bsa', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Cear%C3%A1_Sporting_Club_logo.svg/200px-Cear%C3%A1_Sporting_Club_logo.svg.png', colors: ['#000000', '#FFFFFF'], founded: 1914, stadium: 'Castelão' },
